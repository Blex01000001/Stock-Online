namespace Stock_Online.DTOs.UpdateRequest
{
    // 定義維度的枚舉
    public enum StockScope { Single, Common, All } // 更新股票的範圍 單一 常用 全部
    public enum DataType { PriceUpdater, DividendUpdater, ShareHoldingUpdater, InstitutionalInvestorsBuySellUpdater } // 更新資料的類型
