...
using Stock_Online.Application.Services.KLine.Queries;
using Stock_Online.Application.Services.PatternRecognition.Models.Response;
...
namespace Stock_Online.Application.Services.PatternRecognition
{
    public class PatternRecognitionService : IPatternRecognitionService
    {
        ...
        {
            _repo = repo;
            _priceAdjService = priceAdjService;
            _patterns = patterns;
